            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="<?= base_url($role . '/schedule') ?>" class="btn btn-secondary float-end">Kembali</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">
                                                        <button type="button" class="btn btn-info" id="addRow" disabled>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-4">
                                                                    ...
                                                                    <input type="number" class="form-control" step="0.01" min="0.01" name="qty_celup[]" value="<?= $detail['qty_celup'] ?>" readonly required>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-3">
                                                                ...
                                                                <div class="col-3 d-flex align-items-center">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="checkbox" id="po_plus" class="form-control form-check-input" name="po_plus[]" value="1" <?= $detail['po_plus'] == 1 ? 'checked' : '' ?> disabled>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="text-center">
                                                            <button type="button" class="btn btn-info editRow" data-id="<?= $detail['id_celup'] ?>" data-tanggalschedule="<?= $tanggal_schedule ?>" disabled>
                                                                <i class="fas fa-calendar-alt"></i>
                                                            </button>
                                                            <button type="button" class="btn btn-danger removeRow" disabled>
