...
class PengeluaranModel extends Model
{
    ...
    public function getPengeluaranByPemesanan($idTotalPemesanan)
    {
        ...
        $builder->join('total_pemesanan', 'total_pemesanan.id_total_pemesanan = pengeluaran.id_total_pemesanan', 'left');
        $builder->join('pemesanan', 'pemesanan.id_total_pemesanan=total_pemesanan.id_total_pemesanan');
        ...
        $builder->join('stock', 'stock.item_type = material.item_type AND stock.kode_warna = material.kode_warna AND stock.warna = material.color AND master_order.no_model=stock.no_model AND stock.nama_cluster=pengeluaran.nama_cluster AND lot_stock=pengeluaran.lot_out', 'left');
        ...
        $builder->orderBy('pengeluaran.id_pengeluaran', 'ASC');
